...
public class ProgressiveValueTimerTests
{
    ...
    public void ProgressiveValueTimer_IncrementalOperation_UpdatesValueCorrectly()
    {
        ...
        // Assert
        Assert.AreEqual(end, callbackValue, 0.01f, "Incremental operation did not reach the expected value.");
    }
    ...
    public void DecrementalOperation_UpdatesValueCorrectly()
    {
        ...
        // Assert
        Assert.AreEqual(end, callbackValue, 0.01f, "Decremental operation did not reach the expected value.");
    }
    ...
    public void Timer_DoesNotUpdate_WhenComplete()
    {
        ...
        float finalValue = callbackValue;

        // Another update should NOT change value
        timer.Update(interval);

        // Assert
        Assert.AreEqual(finalValue, callbackValue, "Timer should not update after reaching the end.");
    }
    ...
    public void Timer_ResetsCorrectly()
    {
        ...
        // Assert
        Assert.AreEqual(initial * 1.2f, callbackValue, 0.01f, "Reset did not correctly apply the initial value.");
    }
}
